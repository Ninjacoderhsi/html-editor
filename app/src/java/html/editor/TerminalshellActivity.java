...
public class TerminalshellActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.terminalshell);
			...
			public boolean onLongClick(View _view) {
				...
				java.lang.System.setOut(new java.io.PrintStream(new java.io.OutputStream() {
						...
						public void write(int oneByte) throws java.io.IOException {
								...
								edittext2.setText(new String(outputStream.toByteArray()));
						}
				}));
				return true;
			}
		  ...
		  public static class Console implements java.io.Closeable {
			    ...
			    Console(Builder builder) throws ShellNotFoundException {
				      try {
					        ...
					        TerminalshellActivity aan = new TerminalshellActivity();
	...
	private class RunCommandTask extends AsyncTask<String, Void, CommandResult> {
		...
		@Override protected void onPreExecute() {
			dialog = ProgressDialog.show(TerminalshellActivity.this, "Running Command", "Please Wait...");
	...
	public void onStart() {
		super.onStart();
		_fab.setImageResource(R.drawable.runshell);
	}
